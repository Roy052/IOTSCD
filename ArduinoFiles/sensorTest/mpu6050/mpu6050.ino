...
void loop()
{
  ...
  int rb = digitalRead(5); // 우클릭, 위와 마찬가지
  ...
  if (lb == 1 && rb == 1) {
    ...
    if (timer1 > 50) {
      ...
      while(1) { 
        ...
        switch(sens_num) {
           case 5: sens = 820; break;
           case 4: sens = 850; break;
           case 3: sens = 1100; break;
           case 2: sens = 1220; break;
           case 1: sens = 1380; break;
           default: break;
        }
